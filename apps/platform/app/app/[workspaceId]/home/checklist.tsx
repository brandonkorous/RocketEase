...
export async function loadChecklist(workspaceId: string): Promise<{ steps: ChecklistStep[]; allDone: boolean }> {
  ...
  const steps: ChecklistStep[] = [
    ...
    { n: 3, title: "Create your first post", desc: "Write once, adapt per channel, and schedule it.", done: items > 0, cta: "Create post", href: p("create") },
    { n: 4, title: "Invite your team", desc: "Collaborate with teammates and assign roles.", done: members > 1 || invites > 0, cta: "Invite teammates", href: p("team") },
    { n: 5, title: "Publish your first post", desc: "See it live, then review results in Analytics.", done: published > 0, cta: "Open calendar", href: p("calendar") },
  ];
