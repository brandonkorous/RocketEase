...
export type Snapshot = { text: string; link: string | null; media: { id: string; url: string | null; alt: string }[] };
...
export type CommentRow = { id: string; by: string; image: string | null; body: string; at: string; mine: boolean; resolved: boolean };
