...
export type ComposerChannel = { id: string; provider: string; network: string; kind: string; name: string; handle: string | null; avatarUrl: string | null; status: string; formats: string[]; textMax: number | null; firstComment: boolean; links: string };
