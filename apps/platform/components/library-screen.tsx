...
import { ImportCanvaDialog } from "./library/import-canva";
  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {data.canEdit && data.canva.configured && <ImportCanvaDialog workspaceId={data.workspaceId} canva={data.canva} trigger={<Button variant="outline" color="neutral">Import from Canva</Button>} />}
