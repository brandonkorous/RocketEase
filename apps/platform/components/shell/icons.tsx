import { CalendarIcon, ChartIcon, FolderIcon, HomeIcon, ImageIcon, InboxIcon, SendIcon, SettingsIcon, ShieldIcon } from "@make-it-social/ui/icons";
...
export const NAV_ICONS: Record<NavKey, React.ReactNode> = {
  home: <HomeIcon />, calendar: <CalendarIcon size={18} />, create: <SendIcon size={18} />, inbox: <InboxIcon size={18} />, campaigns: <FolderIcon />, analytics: <ChartIcon size={18} />,
  content: <ImageIcon size={18} />, approvals: <ShieldIcon />, accounts: <PlugIcon />, team: <UsersIcon />, settings: <SettingsIcon />,
};
