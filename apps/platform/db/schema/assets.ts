...
export type AssetProvenance = {
  ...
  /** Ordered: generated by model X, imported from Canva design Y, captions burned in, resized to 9:16. `ref` is the outside id (a design, an export job); `detail` the words. */
  chain: { action: string; adapter?: string; model?: string; ref?: string; detail?: string }[];
};
