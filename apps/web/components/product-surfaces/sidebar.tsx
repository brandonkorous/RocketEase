...
import { CalendarIcon, ChartIcon, FolderIcon, HomeIcon, InboxIcon, Mark, SendIcon, SettingsIcon, ShieldIcon } from "@rocketease/ui/icons";

/** Illustrative app sidebar: black rail, product nav, no platform color. */
export function AppSidebar({ active }: { active: "calendar" | "home" }) {
  return (
    <div data-theme="rke-dark" className="hidden w-42 shrink-0 self-stretch bg-base-100 text-base-content md:block">
