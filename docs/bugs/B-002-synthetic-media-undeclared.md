...
**Verified** with the disclosure on "No AI-generated media": *"ai-image-2026-09-01-1.png"
was generated by AI, but this post doesn't declare synthetic media.* Clears the moment
synthetic is declared; silent for a non-AI upload. Also confirmed `generatedByAi` is
actually set on generated assets — the detail panel keys off `media_job_id`, so that was
