...
import type { RkeClient } from "./client.js";
import { registerTools } from "./tools.js";

export const SERVER_INFO = { name: "rocketease", version: "0.1.0" };

const INSTRUCTIONS = `RocketEase is the publishing layer under you: it holds the connected accounts, the approval policy, the audit trail and the publish receipts.
...
export function createServer(client: RkeClient): McpServer {
